...
public class FavoriteMangaFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getAllFavoriteManga(Objects.requireNonNull(user));
        return view;
    }

    private List<String> getAllFavoriteManga(FirebaseUser user){
        List<String> mangaIds = new ArrayList<>();
        Cursor cursor = null;
        try {
            cursor = databaseManager.getMangaFromUser(DatabaseHelper.TABLE_FAVORITES, user.getUid());
    ...
    private void fillMangaList(FirebaseUser user){
        List<String> mangaIds = getAllFavoriteManga(user);
