...
public class ReadingMangaFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getAllReadingManga(Objects.requireNonNull(user));
        return view;
    }

    private List<String> getAllReadingManga(FirebaseUser user){
        List<String> mangaIds = new ArrayList<>();
        Cursor cursor = null;
        try {
            cursor = databaseManager.getMangaFromUser(DatabaseHelper.TABLE_READING, user.getUid());
    ...
    private void fillMangaList(FirebaseUser user){
        List<String> mangaIds = getAllReadingManga(user);
