...
public class PendingMangaFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getAllPendingManga(Objects.requireNonNull(user));
        return view;
    }

    private List<String> getAllPendingManga(FirebaseUser user){
        List<String> mangaIds = new ArrayList<>();
        Cursor cursor = null;
        try {
            cursor = databaseManager.getMangaFromUser(DatabaseHelper.TABLE_PENDING, user.getUid());
    ...
    private void fillMangaList(FirebaseUser user){
        List<String> mangaIds = getAllPendingManga(user);
