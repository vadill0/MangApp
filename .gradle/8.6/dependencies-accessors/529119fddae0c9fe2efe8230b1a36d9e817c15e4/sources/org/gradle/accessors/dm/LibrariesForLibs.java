...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class FirebaseAppcheckLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        private final FirebaseAppcheckPlayLibraryAccessors laccForFirebaseAppcheckPlayLibraryAccessors = new FirebaseAppcheckPlayLibraryAccessors(owner);
         ...
         * with version reference <b>firebaseAppcheckPlayintegrity</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
         ...
         * with version reference <b>firebaseAppcheckPlayIntegrityVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        ...
        /**
         * Group of libraries at <b>firebase.appcheck.play</b>
         */
        public FirebaseAppcheckPlayLibraryAccessors getPlay() {
            return laccForFirebaseAppcheckPlayLibraryAccessors;
        }

    }

    public static class FirebaseAppcheckPlayLibraryAccessors extends SubDependencyFactory {

        public FirebaseAppcheckPlayLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>integrity</b> with <b>com.google.firebase:firebase-appcheck-play-integrity</b> coordinates and
         * with version reference <b>firebaseAppcheckPlayIntegrityVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getIntegrity() {
            return create("firebase.appcheck.play.integrity");
        }
    ...
    public static class GoogleFirebaseLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>firebaseStorageVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class GoogleFirebaseAppcheckLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>v1600beta01</b> with <b>com.google.firebase:firebase-appcheck</b> coordinates and
         * with version reference <b>googleFirebaseAppcheck</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV1600beta01() {
            return create("google.firebase.appcheck.v1600beta01");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>firebaseAppcheckPlayIntegrityVersion</b> with value <b>16.0.0-beta01</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getFirebaseAppcheckPlayIntegrityVersion() { return getVersion("firebaseAppcheckPlayIntegrityVersion"); }

        /**
         * Version alias <b>firebaseAppcheckPlayintegrity</b> with value <b>18.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getFirebaseAppcheckPlayintegrity() { return getVersion("firebaseAppcheckPlayintegrity"); }
        ...
        /**
         * Version alias <b>firebaseStorageVersion</b> with value <b>21.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getFirebaseStorageVersion() { return getVersion("firebaseStorageVersion"); }
        ...
        /**
         * Version alias <b>googleFirebaseAppcheck</b> with value <b>16.0.0-beta01</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getGoogleFirebaseAppcheck() { return getVersion("googleFirebaseAppcheck"); }
